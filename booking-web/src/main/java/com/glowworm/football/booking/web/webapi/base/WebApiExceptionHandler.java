...
import com.glowworm.football.booking.web.webapi.base.error.ErrorCode;
...
public class WebApiExceptionHandler {
    ...
    private String customizeMessage (String webTraceId, Exception exception, ErrorCode errorCode) {
        ...
        return String.format("%s: [%s]", errorCode.getMessage(), webTraceId);
    }

    private boolean useExceptionMessage (Exception exception) {

        // 定制的异常类
        boolean customizeType = exception instanceof ValidateException;
